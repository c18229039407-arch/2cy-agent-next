import { ConfigV1 } from "@2cy/core/v1/config/config"
...
import { SessionMessageTable } from "@2cy/core/session/sql"
...
import { Shell } from "@2cy/core/shell"
import { Snapshot } from "../../src/snapshot"
import { ToolRegistry } from "@/tool/registry"
import { Truncate } from "@/tool/truncate"
import { CrossSpawnSpawner } from "@2cy/core/cross-spawn-spawner"
...
import { LocationServiceMap, locationServiceMapLayer } from "@2cy/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/2cy/src/session/processor.ts")
