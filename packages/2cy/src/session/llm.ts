...
import { llmClient } from "@2cy/core/effect/app-node-platform"
...
import type { LLMEvent } from "@2cy/llm"
import { LLMClient } from "@2cy/llm/route"
import type { LLMClientService } from "@2cy/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @2cy/llm. It
