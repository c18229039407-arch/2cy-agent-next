import type { JsonSchema, LLMRequest, ProviderMetadata } from "@2cy/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@2cy/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @2cy/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
