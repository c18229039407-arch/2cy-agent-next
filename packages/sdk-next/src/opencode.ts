import { OpenCode } from "@2cy/client/effect"
...
import { createEmbeddedRoutes } from "@2cy/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@2cy/sdk-next/OpenCode") {}
