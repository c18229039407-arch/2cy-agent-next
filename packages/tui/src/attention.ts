...
import defaultSoundPath from "@2cy/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@2cy/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@2cy/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@2cy/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@2cy/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@2cy/ui/audio/yup-01.mp3" with { type: "file" }
