...
- Effect plugins import `@2cy/plugin/v2/effect`, not `@2cy/core`.
- Public domain values use generated `@2cy/sdk` types.
...
- Define `PluginHost` domain capabilities in `@2cy/plugin/v2/effect`.
