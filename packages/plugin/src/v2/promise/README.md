...
The Promise plugin API is the async/await equivalent of `@2cy/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@2cy/plugin/v2/promise"
