...
> current private `@2cy/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@2cy/ai`
...
import { LLM } from "@2cy/ai"
import { OpenAI } from "@2cy/ai/providers/openai"
...
```ts
import { LLM } from "@2cy/ai/promise"
import { OpenAI } from "@2cy/ai/providers/openai"
...
```ts
import { LLMSchema } from "@2cy/ai/schema"
...
```ts
import { Provider, Protocol } from "@2cy/ai/provider"
...
@2cy/ai/providers/openai
@2cy/ai/providers/anthropic
@2cy/ai/providers/google
...
```
