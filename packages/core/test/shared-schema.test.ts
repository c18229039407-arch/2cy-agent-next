...
import { ModelV2 } from "@2cy/core/model"
import { SessionV2 } from "@2cy/core/session"
import { Agent } from "@2cy/schema/agent"
import { Location } from "@2cy/schema/location"
import { Model } from "@2cy/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@2cy/schema/prompt"
import { Provider } from "@2cy/schema/provider"
import { Project } from "@2cy/schema/project"
import { ProjectDirectories } from "@2cy/schema/project-directories"
import { PermissionV1 } from "@2cy/schema/permission-v1"
import { Session } from "@2cy/schema/session"
import { SessionInput } from "@2cy/schema/session-input"
import { SessionMessage } from "@2cy/schema/session-message"
import { Workspace } from "@2cy/schema/workspace"
import { Command } from "@2cy/schema/command"
import { Connection } from "@2cy/schema/connection"
import { Credential } from "@2cy/schema/credential"
import { FileSystem } from "@2cy/schema/filesystem"
import { Integration } from "@2cy/schema/integration"
import { LLM } from "@2cy/schema/llm"
import { Permission } from "@2cy/schema/permission"
import { Plugin } from "@2cy/schema/plugin"
import { Pty } from "@2cy/schema/pty"
import { Reference } from "@2cy/schema/reference"
import { SessionTodo } from "@2cy/schema/session-todo"
import { Skill } from "@2cy/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@2cy/schema/schema"
import { ProviderV2 } from "@2cy/core/provider"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@2cy/core/command"),
    import("@2cy/core/integration/connection"),
    import("@2cy/core/credential"),
    import("@2cy/core/filesystem"),
    import("@2cy/core/integration"),
    import("@2cy/core/location"),
    import("@2cy/llm"),
    import("@2cy/core/permission"),
    import("@2cy/core/v1/permission"),
    import("@2cy/core/project/copy"),
    import("@2cy/core/pty"),
    import("@2cy/core/project/schema"),
    import("@2cy/core/reference"),
    import("@2cy/core/session/input"),
    import("@2cy/core/session/message"),
    import("@2cy/core/session/todo"),
    import("@2cy/core/session/prompt"),
    import("@2cy/core/skill"),
    import("@2cy/core/v2-schema"),
    import("@2cy/core/schema"),
    import("@2cy/core/workspace"),
  ])
