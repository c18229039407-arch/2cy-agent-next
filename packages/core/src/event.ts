...
import type { Data, Definition, Payload } from "@2cy/schema/event"
...
import { Durable } from "@2cy/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@2cy/schema/event").ID
export type { Data, Definition, Payload } from "@2cy/schema/event"
