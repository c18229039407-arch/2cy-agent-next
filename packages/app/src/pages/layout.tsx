...
import { getFilename } from "@2cy/core/util/path"
import { Session } from "@2cy/sdk/v2/client"
...
import { toaster } from "@2cy/ui/toast"
...
import { retry } from "@2cy/core/util/retry"
...
import { useTheme, type ColorScheme } from "@2cy/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/c18229039407-arch/2cy-agent-next/issues")}
      renderPanel={() =>
