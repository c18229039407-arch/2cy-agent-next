...
export const dict = {
  ...
  "dialog.provider.2CY.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.2CY.tagline": "可靠的優化模型",
  "dialog.provider.2CYGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "2CY 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 2CY 中使用 {{provider}} 模型。",
  ...
  "provider.connect.2CYZen.line1": "模型服务 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.2CYZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.2CYZen.visit.prefix": "造訪 ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 2CY 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 2CY 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 2CY.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 2CY 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 2CY...",
  ...
  "wsl.onboarding.2CYReadyIn": "{{distro}} 中的 2CY 已就緒。",
  "wsl.onboarding.2CYReady": "2CY 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 2CY。",
  "wsl.onboarding.installOpencode": "安裝 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "未安裝 2CY",
  ...
  "wsl.onboarding.wslUnavailable.description": "2CY 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 2CY。",
  ...
  "toast.update.description": "2CY 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 2CY 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (2CY.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: 2CY 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "2CY 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 2CY 伺服器。",
  ...
  "settings.general.row.language.description": "變更 2CY 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 2CY 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 2CY 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 2CY 的主題。",
  ...
  "settings.updates.row.startup.description": "在 2CY 啟動時自動檢查更新",
