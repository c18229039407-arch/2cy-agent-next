export const dict = {
  ...
  "dialog.provider.2CY.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.2CY.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.2CYGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af 2CY",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.2CYZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.2CYZen.visit.prefix": "Besøg ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i 2CY.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i 2CY.json",
  ...
  "dialog.server.description": "Skift hvilken 2CY-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker 2CY i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer 2CY i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater 2CY i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før 2CY kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "2CY kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter 2CY igen.",
  ...
  "toast.update.description": "En ny version af 2CY ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til 2CY-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (2CY.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, 2CY understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "2CY inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør 2CY-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for 2CY",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan 2CY ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om 2CY følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan 2CY er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når 2CY starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af 2CY.",
