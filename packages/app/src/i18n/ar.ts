export const dict = {
  ...
  "dialog.provider.2CY.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.2CY.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.2CYGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من 2CY",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "يمنحك 模型服务 الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.2CYZen.visit.prefix": "قم بزيارة ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في 2CY.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في 2CY.json",
  ...
  "dialog.server.description": "تبديل خادم 2CY الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من 2CY في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث 2CY في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث 2CY في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY جاهز في {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت 2CY في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن 2CY من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على 2CY التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح 2CY.",
  ...
  "toast.update.description": "نسخة جديدة من 2CY ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق 2CY",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (2CY.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن 2CY لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن 2CY نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم 2CY داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ 2CY",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور 2CY على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان 2CY يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة 2CY.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل 2CY",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من 2CY.",
