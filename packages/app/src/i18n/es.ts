export const dict = {
  ...
  "dialog.provider.2CY.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.2CY.tagline": "Modelos optimizados y fiables",
  "dialog.provider.2CYGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por 2CY",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.2CYZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.2CYZen.visit.prefix": "Visita ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en 2CY.",
  ...
  "dialog.plugins.empty": "Plugins configurados en 2CY.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de 2CY se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando 2CY en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando 2CY en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza 2CY en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY está listo en {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala 2CY en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que 2CY pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "2CY no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir 2CY.",
  ...
  "toast.update.description": "Una nueva versión de 2CY ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de 2CY",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (2CY.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, 2CY no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "2CY incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor 2CY dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para 2CY",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve 2CY en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si 2CY sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de 2CY.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia 2CY",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de 2CY.",
