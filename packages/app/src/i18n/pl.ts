export const dict = {
  ...
  "dialog.provider.2CY.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.2CY.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.2CYGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez 2CY",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.2CYZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.2CYZen.visit.prefix": "Odwiedź ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w 2CY.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w 2CY.json",
  ...
  "dialog.server.description": "Przełącz serwer 2CY, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie 2CY w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie 2CY w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj 2CY w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj 2CY w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim 2CY będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "2CY nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz 2CY.",
  ...
  "toast.update.description": "Nowa wersja 2CY ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu 2CY",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (2CY.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: 2CY nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "2CY zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer 2CY wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla 2CY",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd 2CY na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy 2CY ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw 2CY.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania 2CY",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji 2CY.",
