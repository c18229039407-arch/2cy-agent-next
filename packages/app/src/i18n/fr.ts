export const dict = {
  ...
  "dialog.provider.2CY.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.2CY.tagline": "Modèles optimisés et fiables",
  "dialog.provider.2CYGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par 2CY",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.2CYZen.visit.prefix": "Visitez ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans 2CY.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans 2CY.json",
  ...
  "dialog.server.description": "Changez le serveur 2CY auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'2CY dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'2CY dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour 2CY dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY est prêt dans {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez 2CY dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'2CY puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "2CY n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez 2CY.",
  ...
  "toast.update.description":
    "Une nouvelle version d'2CY ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe 2CY",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (2CY.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'2CY ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "2CY inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur 2CY dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour 2CY",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'2CY sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si 2CY suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'2CY.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'2CY",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'2CY.",
