export const dict = {
  ...
  "dialog.provider.2CY.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.2CY.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.2CYGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "2CYが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、2CYで{{provider}}モデルを使用します。",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务は、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.2CYZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.2CYZen.visit.prefix": " ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続して2CYで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、2CYで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "2CY.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続する2CYサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "2CYを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内の2CYを確認中...",
  "wsl.onboarding.updatingOpencode": "2CYを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内の2CYを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内の2CYを更新してください。",
  "wsl.onboarding.updateOpencode": "2CYを更新",
  "wsl.onboarding.2CYReadyIn": "{{distro}}内の2CYの準備ができました。",
  "wsl.onboarding.2CYReady": "2CYの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}に2CYをインストールしてください。",
  "wsl.onboarding.installOpencode": "2CYをインストール",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CYがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "2CYでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、2CYをもう一度開いてください。",
  ...
  "toast.update.description": "2CYの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを2CYチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (2CY.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: 2CYはまだMCP認証をサポートしていません。',
  ...
  "home.sessions.empty.greeting": "原稿デスクへようこそ。仕事をください、始めましょう。",
  "home.sessions.empty.step1": "① 「設定」でモデルの API キーを入力",
  "home.sessions.empty.step2": "② 「プロジェクト追加」で作業フォルダを選択",
  "home.sessions.empty.step3": "③ 新しいコマを開いて仕事を渡す",
  ...
  "sidebar.gettingStarted.line1": "2CYには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境で2CYサーバーを実行します。",
  ...
  "settings.general.row.language.description": "2CYの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでの2CYの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "2CYがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "2CYのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "2CY の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "2CY は最新バージョンです。",
