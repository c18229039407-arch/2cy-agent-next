export const dict = {
  ...
  "dialog.provider.2CY.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.2CY.tagline": "Reliable optimized models",
  "dialog.provider.2CYGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by 2CY",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in 2CY.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.2CYZen.line1":
    "模型服务 gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.2CYZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.2CYZen.visit.prefix": "Visit ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in 2CY.",
  ...
  "dialog.plugins.empty": "Plugins configured in 2CY.json",
  ...
  "dialog.server.description": "Switch which 2CY server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Checking 2CY in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Updating 2CY in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update 2CY in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY is ready in {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY is ready.",
  "wsl.onboarding.installOpencodeIn": "Install 2CY in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before 2CY can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "2CY could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen 2CY.",
  ...
  "toast.update.description": "A new version of 2CY ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the 2CY team",
  ...
  "error.chain.checkConfig": "Check your config (2CY.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, 2CY does not support MCP authentication yet.',
  ...
  "home.sessions.empty.greeting": "Welcome to the manuscript desk. Give me a task and we begin.",
  "home.sessions.empty.step1": "① Add your model API key in Settings",
  "home.sessions.empty.step2": "② Click Add project and pick a working folder",
  "home.sessions.empty.step3": "③ Start a new panel and hand me the task",
  ...
  "sidebar.gettingStarted.line1": "2CY includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the 2CY server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for 2CY",
  ...
  "settings.general.row.appearance.description": "Customise how 2CY looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether 2CY follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how 2CY is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when 2CY launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of 2CY.",
