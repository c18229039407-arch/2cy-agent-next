...
export const dict = {
  ...
  "dialog.provider.2CY.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.2CY.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.2CYGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "2CY tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve 2CY'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.2CYZen.visit.prefix": "",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak 2CY'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak 2CY'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler 2CY.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi 2CY sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "2CY kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde 2CY kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "2CY güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde 2CY güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki 2CY'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "2CY'u güncelle",
  "wsl.onboarding.2CYReadyIn": "{{distro}} içinde 2CY hazır.",
  "wsl.onboarding.2CYReady": "2CY hazır.",
  "wsl.onboarding.installOpencodeIn": "2CY'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "2CY'u kur",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "2CY'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "2CY bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından 2CY'u tekrar açın.",
  ...
  "toast.update.description": "2CY'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı 2CY ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (2CY.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: 2CY henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "2CY ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.desktop.wsl.description": "2CY sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "2CY'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "2CY'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "2CY'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "2CY'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "2CY başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "2CY'un en son sürümünü kullanıyorsunuz.",
