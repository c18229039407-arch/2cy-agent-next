...
export const dict = {
  ...
  "dialog.provider.2CY.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.2CY.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.2CYGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von 2CY",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 2CY zu nutzen.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.2CYZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in 2CY zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in 2CY zu nutzen.",
  ...
  "dialog.plugins.empty": "In 2CY.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den 2CY-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "2CY wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "2CY in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "2CY wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "2CY in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie 2CY in {{distro}}.",
  "wsl.onboarding.updateOpencode": "2CY aktualisieren",
  "wsl.onboarding.2CYReadyIn": "2CY ist in {{distro}} bereit.",
  "wsl.onboarding.2CYReady": "2CY ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie 2CY in {{distro}}.",
  "wsl.onboarding.installOpencode": "2CY installieren",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor 2CY einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "2CY konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann 2CY erneut.",
  ...
  "toast.update.description": "Eine neue Version von 2CY ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem 2CY-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (2CY.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: 2CY unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "2CY enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "2CY-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für 2CY ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie 2CY auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob 2CY dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von 2CY anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von 2CY automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von 2CY.",
