...
export const dict = {
  ...
  "command.permissions.autoaccept.enable": "全权委托",
  "command.permissions.autoaccept.disable": "收回全权委托",
  ...
  "command.session.compact": "整理前情提要",
  "command.session.compact.description": "把之前的对话整理成一张前情提要，腾出上下文",
  ...
  "dialog.provider.2CY.note": "使用 模型服务 或 API 密钥连接",
  "dialog.provider.2CY.tagline": "可靠的优化模型",
  "dialog.provider.2CYGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "2CY 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 2CY 中使用 {{provider}} 模型。",
  ...
  "provider.connect.2CYZen.line1": "模型服务 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.2CYZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.2CYZen.visit.prefix": "访问 ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 2CY 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 2CY 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 2CY.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 2CY 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 2CY...",
  "wsl.onboarding.updatingOpencode": "正在更新 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 2CY...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 2CY。",
  "wsl.onboarding.updateOpencode": "更新 2CY",
  "wsl.onboarding.2CYReadyIn": "{{distro}} 中的 2CY 已就绪。",
  "wsl.onboarding.2CYReady": "2CY 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 2CY。",
  "wsl.onboarding.installOpencode": "安装 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "未安装 2CY",
  ...
  "wsl.onboarding.wslNotInstalled.description": "2CY 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "2CY 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 2CY。",
  ...
  "toast.permissions.autoaccept.on.title": "已全权委托",
  "toast.permissions.autoaccept.on.description": "权限请求将自动盖「准」",
  "toast.permissions.autoaccept.off.title": "已收回全权委托",
  "toast.permissions.autoaccept.off.description": "权限请求将需要你亲自盖章",
  ...
  "toast.update.description": "2CY 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 2CY 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (2CY.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: 2CY 暂不支持 MCP 认证。',
  ...
  "notification.permission.title": "等你盖章",
  ...
  "home.sessions.empty": "原稿桌还空着",
  "home.sessions.empty.description": "新开一格分镜，和她一起开工。",
  "home.sessions.empty.greeting": "欢迎回到原稿桌。给我一个任务，我们开工吧。",
  "home.sessions.empty.step1": "① 进「设置」填入你的模型 API Key",
  "home.sessions.empty.step2": "② 点「添加项目」选一个工作文件夹",
  "home.sessions.empty.step3": "③ 新开一格分镜，把任务交给我",
  ...
  "sidebar.gettingStarted.line1": "2CY 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 2CY 服务器。",
  ...
  "settings.general.row.language.description": "更改 2CY 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 2CY 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 2CY 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 2CY 的主题。",
  ...
  "settings.updates.row.startup.description": "在 2CY 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 2CY。",
  ...
  "settings.permissions.action.allow": "准",
  "settings.permissions.action.ask": "询问",
  "settings.permissions.action.deny": "不行",
