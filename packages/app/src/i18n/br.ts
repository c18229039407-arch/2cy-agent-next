export const dict = {
  ...
  "dialog.provider.2CY.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.2CY.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.2CYGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo 2CY",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.2CYZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.2CYZen.visit.prefix": "Visite ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no 2CY.",
  ...
  "dialog.plugins.empty": "Plugins configurados em 2CY.json",
  ...
  "dialog.server.description": "Trocar para qual servidor 2CY este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o 2CY em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o 2CY em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o 2CY em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o 2CY",
  "wsl.onboarding.2CYReadyIn": "O 2CY está pronto em {{distro}}.",
  "wsl.onboarding.2CYReady": "O 2CY está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o 2CY em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o 2CY possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O 2CY não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o 2CY novamente.",
  ...
  "toast.update.description": "Uma nova versão do 2CY ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do 2CY",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (2CY.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: 2CY ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "2CY inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor 2CY dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do 2CY",
  ...
  "settings.general.row.appearance.description": "Personalize como o 2CY aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o 2CY segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o 2CY é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o 2CY iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do 2CY.",
