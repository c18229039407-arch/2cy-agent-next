export const dict = {
  ...
  "dialog.provider.2CY.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.2CY.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.2CYGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje 2CY",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u 2CY-u.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.2CYZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.2CYZen.visit.prefix": "Posjeti ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u 2CY-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u 2CY-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u 2CY.json",
  ...
  "dialog.server.description": "Promijeni na koji se 2CY server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera 2CY u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje 2CY u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj 2CY u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj 2CY u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj 2CY",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi 2CY mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "2CY nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori 2CY.",
  ...
  "toast.update.description": "Nova verzija 2CY-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku 2CY timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (2CY.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: 2CY još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "2CY uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni 2CY server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u 2CY-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako 2CY izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li 2CY prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu 2CY-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se 2CY pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju 2CY-a.",
