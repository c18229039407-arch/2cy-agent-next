...
export const dict = {
  ...
  "dialog.provider.2CY.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.2CY.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.2CYGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av 2CY",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i 2CY.",
  ...
  "provider.connect.2CYZen.line1":
    "模型服务 gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.2CYZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.2CYZen.visit.prefix": "Besøk ",
  "provider.connect.2CYZen.visit.link": "",
  "provider.connect.2CYZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i 2CY.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i 2CY.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i 2CY.json",
  ...
  "dialog.server.description": "Bytt hvilken 2CY-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av 2CY ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til 2CY-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (2CY.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at 2CY ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "2CY inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør 2CY-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for 2CY",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan 2CY ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om 2CY skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan 2CY er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når 2CY starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av 2CY.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker 2CY...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker 2CY i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer 2CY...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer 2CY i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater 2CY i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater 2CY",
  "wsl.onboarding.2CYReadyIn": "2CY er klar i {{distro}}.",
  "wsl.onboarding.2CYReady": "2CY er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer 2CY i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.2CYMissing": "2CY er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før 2CY kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "2CY kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter 2CY på nytt.",
