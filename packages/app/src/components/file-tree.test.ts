...
beforeAll(async () => {
  ...
  mock.module("@2cy/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@2cy/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@2cy/ui/icon", () => ({ Icon: () => null }))
  mock.module("@2cy/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
